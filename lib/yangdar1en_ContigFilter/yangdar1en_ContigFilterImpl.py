...
This sample module contains one small method that filters contigs.
    ...
    def run_yangdar1en_ContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_yangdar1en_ContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_yangdar1en_ContigFilter function. Params=' + pformat(params))
        ...
        #END run_yangdar1en_ContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_yangdar1en_ContigFilter return value ' +
    ...
    def run_yangdar1en_ContigFilter(self, ctx, params):
        ...
        # Download the input data as a Fasta and
        # We can use the AssemblyUtils module to download a FASTA file from our Assembly data object.
        # The return object gives us the path to the file that was created.
        logging.info('Downloading Assembly data as a Fasta file.')
        assemblyUtil = AssemblyUtil(self.callback_url)
        ...
        # Actually perform the filter operation, saving the good contigs to a new fasta file.
        # We can use BioPython to parse the Fasta file and build and save the output to a file.
        good_contigs = []
        n_total = 0
        n_remaining = 0
        ...
        # Save the new Assembly back to the system
        logging.info('Uploading filtered Assembly data.')
        new_assembly = assemblyUtil.save_assembly_from_fasta({'file': {'path': filtered_fasta_file},
                                                              'workspace_name': workspace_name,
                                                              'assembly_name': fasta_file['assembly_name']
    ...
    def run_yangdar1en_ContigFilter_max(self, ctx, params):
        """
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_yangdar1en_ContigFilter_max
        ...
        # A list of contigs greater than min_length
        good_contigs = []
        ...
        #END run_yangdar1en_ContigFilter_max

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_yangdar1en_ContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
